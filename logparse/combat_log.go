...
// func NewCombatLogParser(nickname string) *CombatLogParser {
// 	return &CombatLogParser{yourNickname: nickname}
// }

// // func (p *CombatLogParser) Parse(
...
// func (p *CombatLogParser) ParseLog(r io.Reader) (awards, punishments []*DeathRecord, err error) {
...
// func (p *CombatLogParser) validate() error {
...
// func (p *CombatLogParser) ParseAwardsList(r io.Reader) error

// func (p *CombatLogParser) ParsePunishmentsList(r io.Reader) error

// func (p *CombatLogParser) parseNcknamesList(r io.Reader) (map[string]int, error) {
// 	scanner := bufio.NewScanner(r)
